...
if __name__=='__main__':
    ...
    tflearn.init_graph(num_cores=8, gpu_memory_fraction=0.2)  # 限制GPU使用内存
    ...
    model.fit(Train_X, Train_Y, n_epoch=1, validation_set=0.1, shuffle=True,
    ...
    print('ALexNet Test acc is', acc)
    checkpoint_dir = './training_checkpoints'
    checkpoint_prefix = os.path.join(checkpoint_dir, "ckpt_{epoch}")
    conf_mat = confusion_matrix(aa, ab)
    print(conf_mat)
