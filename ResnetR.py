# -*- coding: utf-8 -*-
"""
Created on Tue Mar 31 00:40:22 2020
...
if __name__=='__main__':
    ...
    #tflearn.init_graph(num_cores=4, gpu_memory_fraction=0.5)#限制GPU使用内存
    ...
    model.fit(Train_X, Train_Y, n_epoch=1, validation_set=(Test_X, Test_Y),
              show_metric=True, batch_size=32 , run_id='resnet_mnist')
